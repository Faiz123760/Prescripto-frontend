...
const Appointment = () => {
  ...
  const { doctors: doctorsData, currencySymbol } = useContext(AppContext)
  ...
  const fetchDocInfo = () => {
    const doc = doctorsData.find(doc => doc._id === docId)
    setDocInfo(doc)
  }
  ...
  return docInfo && (
    <div>
      ...
      {/* ------------- Booking Slots ------------ */}
      <div className="sm:ml-72 sm:pl-4 mt-4 font-medium font-gray-700">
        <p>Booking slots</p>
